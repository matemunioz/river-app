...
def _pagina_individual_stats(c, ind, n_pag, partido):
    ...
    bloques = [
        ...
        ("Duelos y Remates", [
            ...
            ("Regate +", ind.get("regate_c", 0)),
            ("Regate −", ind.get("regate_i", 0)),
            ("Remates al arco", ind.get("remates_arco", 0)),
            ("Remates afuera", ind.get("remates_afuera", 0)),
            ("Bloqueados", ind.get("remates_bloq", 0)),
        ]),
        ("Posicional", [
